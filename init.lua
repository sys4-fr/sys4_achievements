...
local a = {
   ...
   { name = 'iron_miner_newbee',
     ...
     type = "dig",
     target = 100,
     titems = {'default:rail', 'screwdriver:screwdriver'},
     tprizes = nil,
   },
   ...
   { name = 'copper_miner_begins',
     ...
     desc = "Récolte 50 minerai de cuivre.",
   ...
   { name = "copper_miner_newbee",
     title = "L'age du bronze",
     node = 'default:stone_with_copper',
     desc = "Récolte 100 minerai de cuivre.",
     icon ="default_mineral_copper.png",
     type = "dig",
     target = 100,
   ...
   { name = 'glass_builder_begins',
     title = "Apprendre le verre",
     node = 'default:glass',
     desc = "Place 20 blocs de verre",
     icon ="default_glass.png",
     type = "place",
     target = 20,
     titems = {'doors:door_glass', 'xpanes:panes'},
     tprizes = nil,
   },
   { name = 'glass_crafter_newbee',
     title = "Soufleur de verre",
     node = 'xpanes:glass',
     desc = "Fabrique 40 plaques de verre",
   ...
   { name = 'glass_crafter_good',
     title = "Soufleur de verre confirmé",
     node = 'vessels:bottle',
     desc = "Fabrique 50 bouteilles de verre",
     icon ="vessels_glass_bottle.png",
     type = "craft",
     target = 40,
...
-- wheat
   { name = 'agro_straw_begins',
     title = "Découverte du blé",
     node = 'default:grass_5',
     desc = "Récolte 50 touffes d'herbe mature",
   ...
   { name = 'agro_straw_newbee',
     title = "Céréalier débutant",
     node = 'farming:wheat_8',
     desc = "Récolte 50 plants de blé bien murs.",
     icon = "farming_wheat.png",
     type = "dig",
     target = 50,
     titems = {'farming:floor'},
     tprizes = nil
   },
   
   { name = 'agro_straw_lover',
     title = "Céréalier amateur",
     node = 'farming:wheat_8',
     desc = "Récolte 100 plants de blé bien murs.",
   ...
   { name = 'agro_cotton_begins',
     title = "Découverte du cotton",
     node = 'default:junglegrass',
     desc = "Récolte 50 touffes d'herbe de jungle",
   ...
   { name = 'agro_cotton_newbee',
     title = "La route du cotton",
     node = 'default:cotton_8',
     desc = "Récolte 50 plants de cottons bien murs",
     icon = "farming_cotton.png",
     type = "dig",
     target = 50,
     titems = {'wool:white'},
   ...
   { name = 'hoe_crafter_newbee',
     title = "Agriculteur Débutant",
     node = 'farming:hoe_wood',
     desc = "Fabrique 10 houx en bois.",
   ...
   { name = 'hoe_crafter_lover',
     title = "Agriculteur amateur",
     node = 'farming:hoe_stone',
     desc = "Fabrique 10 houx en pierre.",
   ...
   { name = 'hoe_crafter_good',
     title = "Agriculteur confirmé",
     node = 'farming:hoe_steel',
     desc = "Fabrique 10 houx en fer.",
   ...
   { name = 'hoe_crafter_pro',
     title = "Agriculteur professionnel",
     node = 'farming:hoe_bronze',
     desc = "Fabrique 10 houx en bronze.",
   ...
   { name = 'hoe_crafter_master',
     title = "Maitre Agriculteur",
     node = 'farming:hoe_mese',
     desc = "Fabrique 10 houx en mese.",
   ...
   -- dyes
   { name = 'like_dye_red',
     title = "J'aime le rouge",
     node = 'flowers:rose',
     desc = "Récolte 10 roses rouges.",
     icon = "dye_red.png",
     type = "dig",
     target = 10,
     titems = {'dye:red'},
   ...
   { name = 'like_dye_orange',
     title = "J'aime le orange",
     node = 'flowers:tulip',
     desc = "Récolte 10 tulipes",
     icon = "dye_orange.png",
     type = "dig",
     target = 10,
     titems = {'dye:orange'},
   ...
   { name = 'like_dye_yellow',
     title = "J'aime le jaune",
     node = 'flowers:dandelion_yellow',
     desc = "Récolte 10 dandelions jaunes.",
     icon = "dye_yellow.png",
     type = "dig",
     target = 10,
     titems = {'dye:yellow'},
   ...
   { name = 'like_dye_blue',
     title = "J'aime le bleue",
     node = 'flowers:geranium',
     desc = "Récolte 10 géraniums bleues.",
     icon = "dye_blue.png",
     type = "dig",
     target = 10,
     titems = {'dye:blue'},
   ...
   { name = 'like_dye_white',
     title = "J'aime le blanc",
     node = 'flowers:dandelion_white',
     desc = "Récolte 10 dandelions blancs.",
     icon = "dye_white.png",
     type = "dig",
     target = 10,
     titems = {'dye:white'},
   ...
   { name = 'like_dye_black',
     title = "J'aime le noir",
     node = 'default:stone_with_coal',
     desc = "Récolte 10 minerais de charbon",
     icon = "dye_black.png",
     type = "dig",
     target = 10,
     titems = {'dye:black'},
   ...
   { name = 'like_dye_nyan',
     ...
     node = 'dye:red',
     desc = "Fabrique 10 colorants rouges",
     icon = "dye_brown.png",
     type = "craft",
     target = 10,
   ...
   { name = 'deco_wool_newbee',
     title = "Laine dans tous ces états",
     node = 'wool:white',
     desc = "Fabrique 10 pelotes de laines.",
     icon = "wool_red.png",
     type = "craft",
     target = 10,
   ...
   { name = 'bed_crafter_begins',
     ...
     node = 'wool:red',
     desc = "Fabrique 10 pelotes rouges.",
     icon = "beds_bed.png",
     type = "craft",
     target = 10,
     titems = {'beds:bed'},
   ...
   { name = 'bed_crafter_newbee',
     ...
     node = 'beds:bed',
     desc = "Fabrique 10 lits simples.",
     icon = "beds_bed_fancy.png",
     type = "craft",
     target = 10,
     titems = {'beds:bed_fancy'},
     tprizes = nil
   },
   ...
   { name = 'gravel_digger_begins',
     title = "Poudre noire",
     node = 'default:gravel',
     desc = "Récolte 100 blocs de graviers.",
   ...
   { name = 'tnt_man',
     title = "Boum !",
     node = 'tnt:gunpowder',
     desc = "Fabrique 10 barils de poudre.",
     icon = "tnt_side.png",
     type = "craft",
     target = 10,
     titems = {'tnt:tnt'},
