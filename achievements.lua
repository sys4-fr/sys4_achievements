...
function sys4_achievements.getAchievements(listName, lvl)
   ...
   if listName == "sys4" then
	 ...
	 { name = 'tree_digger',
	   ...
	   type = "dig",
	   target = 1 * lvl,
	   titems = {'default:wood', 'default:junglewood', 'default:pine_wood', 'default:acacia_wood'},
	   tprizes = nil,
	 ...
	 { name = 'planks_crafter',
	   title = S("Make planks"),
	   node = 'default:wood',
	   desc = S("Craft ")..(8 * lvl).." "..S("default:wood")..".",
	   icon = "default_wood.png",
	   type = "craft",
	   target = 8 * lvl,
	   titems = {'default:stick', 'default:chest', 'doors:door_wood', 'doors:trapdoor', 'boats:boat'},
	   tprizes = nil,
	   tbook = S("Make planks from wood"),
	 ...
	 { name = 'sticks_crafter',
	   title = S("Make sticks"),
	   node = 'default:stick',
	   desc = S("Craft ")..(8 * lvl).." "..S("default:stick")..".",
	   icon = "default_stick.png",
	   type = "craft",
	   target = 8 * lvl,
	   titems = {'default:sword_wood', 'default:axe_wood', 'default:shovel_wood', 'farming:hoe_wood', 'default:ladder', 'default:fence_wood'},
	   tprizes = nil,
	   tbook = S("Make sticks from planks"),
	   award_req = 'planks_crafter',
	 },

	 { name = 'pick_crafter',
	   title = S("Make a wooden pick"),
	   ...
	   titems = nil,
	   tprizes = nil,
	   tbook = S("Make a wooden pick from sticks and planks"),
	   award_req = 'award_lumberjack',
	 },

	 { name = 'axe_crafter',
	   title = S("Make a wooden axe"),
	   node = 'default:axe_wood',
	   desc = S("Craft ")..(1 * lvl).." "..S("default:axe_wood")..".",
	   icon = "default_tool_woodaxe.png",
	   type = "craft",
	   target = 1 * lvl,
	   titems = nil,
	   tprizes = nil,
	   tbook = S("Make a wooden axe from sticks and planks"),
	   award_req = 'sticks_crafter',
	 },

	 { name = 'sword_crafter',
	   title = S("Make a wooden sword"),
	   node = 'default:sword_wood',
	   desc = S("Craft ")..(1 * lvl).." "..S("default:sword_wood")..".",
	   icon = "default_tool_woodsword.png",
	   type = "craft",
	   target = 1 * lvl,
	   titems = nil,
	   tprizes = nil,
	   tbook = S("Make a wooden sword from sticks and planks"),
	   award_req = 'sticks_crafter',
	 },

	 { name = 'shovel_crafter',
	   title = S("Make a wooden shovel"),
	   node = 'default:shovel_wood',
	   desc = S("Craft ")..(1 * lvl).." "..S("default:shovel_wood")..".",
	   icon = "default_tool_woodshovel.png",
	   type = "craft",
	   target = 1 * lvl,
	   titems = nil,
	   tprizes = nil,
	   tbook = S("Make a wooden shovel from sticks and planks"),
	   award_req = 'sticks_crafter',
	 },

	 { name = 'hoe_crafter',
	   title = S("Make a wooden hoe"),
	   ...
	   titems = nil,
	   tprizes = nil,
	   tbook = S("Make a wooden hoe from sticks and planks"),
	   award_req = 'sticks_crafter',
	 },
	 ...
	 { name = 'wheat_digger_lover',
	   ...
	   node = 'farming:wheat_8',
	   desc = S("Dig ")..(100*lvl).." "..S("farming:wheat")..".",
	 ...
	 { name = 'cotton_digger_begins',
	   ...
	   desc = S("Dig ")..(8*lvl).." "..S("farming:cotton")..".",
	   icon = "wool_white.png",
	   type = "dig",
	   target = 8*lvl,
	   titems = {'wool:white'},
	 ...
	 { name = 'stone_digger',
	   title = S("Finding stone"),
	   node = 'default:stone',
	   desc = S("Dig ")..(1 * lvl).." "..S("default:stone")..".",
	   icon = "default_stone.png",
	   type = "dig",
	   target = 1 * lvl,
	   titems = {'default:furnace', 'default:axe_stone', 'default:sword_stone', 'default:shovel_stone', 'farming:hoe_stone'},
	   tprizes = nil,
	   tbook = S("Find stone and make your first stone tools."),
	   award_req = 'pick_crafter',
	 },

	 { name = 'coal_digger',
	   title = S("Finding coal"),
	   node = 'default:stone_with_coal',
	   desc = S("Dig ")..(1 * lvl).." "..S("default:stone_with_coal")..".",
	   icon = "default_coal_lump.png",
	   type = "dig",
	   target = 1 * lvl,
	   titems = {'default:torch', 'dye:black', 'wool:black'},
	   tprizes = nil,
	   tbook = S("Find coal and discover her uses."),
	   award_req = 'pick_crafter',
	 },

	 { name = 'dye_crafter',
	   title = S("A colorful World"),
	   node = 'dye:black',
	   desc = S("Craft ")..(100 * lvl).." "..S("dye:black")..".",
	   icon = "dye_red.png",
	   type = "craft",
	   target = 100 * lvl,
	   titems = {'dye:red', 'dye:blue', 'dye:yellow', 'dye:white', 'dye:orange', 'dye:violet', 'dye:green'},
	   tprizes = nil,
	   tbook = S("Discover how to make others colored dyes."),
	   award_req = 'coal_digger',
	 },

	 { name = 'wool_crafter',
	   title = S("Colored Wools"),
	   node = 'wool:black',
	   desc = S("Craft ")..(100 * lvl).." "..S("wool:black")..".",
	   icon = "wool_red.png",
	   type = "craft",
	   target = 100 * lvl,
	 ...
	 { name = 'dye_crafter_begins',
	   title = S("Picasso"),
	   node = 'dye:black',
	   desc = S("Craft ")..(200*lvl).." "..S("group:dye")..".",
	   icon = "dye_brown.png",
	   type = "craft",
	   target = 200*lvl,
	   titems = {'dye:brown','dye:cyan', 'dye:dark_green', 'dye:dark_grey', 'dye:grey', 'dye:magenta', 'dye:pink'},
	   tprizes = nil,
	   award_req = 'coal_digger'
	 },

	 -- Craft 100 colored wools : Unlock All the others colored wools.
	 { name = 'wool_crafter_begins',
	   title = S("The Rainbow Wools"),
	   node = 'wool:red',
	   desc = S("Craft ")..(200*lvl).." "..S("group:wools")..".",
	   icon = "wool_brown.png",
	   type = "craft",
	   target = 200*lvl,
	   titems = {'wool:brown','wool:cyan', 'wool:dark_green', 'wool:dark_grey', 'wool:grey', 'wool:magenta', 'wool:pink'},
	   tprizes = nil,
	   award_req = 'coal_digger'
	 },

	 { name = 'coal_digger_lover',
	   title = S("Find more coal"),
	   node = 'default:stone_with_coal',
	   ...
	   tprizes = nil,
	   tbook = S("Find more coal and discover how to compress it."),
	   award_req = 'pick_crafter',
	 },
	 ...
	 { name = 'pick_crafter_lover',
	   ...
	   award_req = 'award_mine2'
	 },   

	 -- Dig 10 iron stones : unlock bucket, bars, steel door, steel bottle and steel tools
	 ...
	 { name = 'bucket_crafter',
	   title = S("Craft a bucket"),
	   node = 'bucket:bucket_empty',
	   desc = S("Craft ")..(1*lvl).." "..S("bucket:bucket_empty")..".",
	 ...
	 { name = 'iron_digger_lover',
	   ...
	   type = "dig",
	   target = 100*lvl,
	   titems = {'default:pick_steel', 'default:steelblock', 'default:steel_ingot'},
	   tprizes = nil,
	   award_req = 'pick_crafter_lover'
	 },

	 -- Dig 100 copper stone : unlock copper block, copper ingot.
	 { name = 'copper_digger_begins',
	   ...
	   type = "dig",
	   target = 100*lvl,
	   titems = {'default:copperblock', 'default:copper_ingot', 'default:bronze_ingot'},
	   tprizes = nil,
	   award_req = 'pick_crafter_lover'
	 },

	 -- Craft 1 bronze ingot
	 { name = 'bronze_crafter',
	   ...
	   type = "craft",
	   target = 1*lvl,
	   titems = {'default:sword_bronze', 'default:axe_bronze', 'default:shovel_bronze', 'farming:hoe_bronze'},
	   tprizes = nil,
	   award_req = 'copper_digger_begins'
	 },

	 -- Craft 100 bronze ingot
	 { name = 'bronze_crafter_lover',
	   title = S("The Bronze Peak"),
	   node = 'default:bronze_ingot',
	   desc = S("Craft ")..(100*lvl).." "..S("default:bronze_ingot")..".",
	   icon = "default_bronze_ingot.png",
	   type = "craft",
	   target = 100*lvl,
   ...
   if listName == nil or listName == "" or listName == "default" then
